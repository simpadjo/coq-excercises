...
Definition conj_fact : forall P Q R, P /\ Q -> Q /\ R -> P /\ R := 
 ...
 match H with
 | conj H1 _ => match H0 with
                | conj _ H4 => conj H1 H4
                end
 end).
  (* Proof.
   intros. destruct H, H0. split. assumption. assumption.
   Show Proof. Qed. *)
(** [] *)
...
Definition ex_ev_Sn : ex (fun n => even (S n)):= ex_intro (fun n => even (S n)) 3 (ev_4).
(** [] *)
